...
build {
  ...
  # # wmic which was deprecated seems to have been removed in windows 2025
  # # provisioner "windows-shell" {
  # #   inline = ["wmic product where \"name like '%%microsoft azure powershell%%'\" call uninstall /nointeractive"]
  # # }

  # #Commenting as it is failing in windows 2025
  # # provisioner "windows-shell" {
  # #   inline = [
  # #       "powershell -Command \"Get-Package -Name 'Microsoft Azure PowerShell' | Uninstall-Package -Force\""
  # #   ]
  # # }
